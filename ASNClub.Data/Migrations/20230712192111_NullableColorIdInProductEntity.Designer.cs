...
namespace ASNClub.Data.Migrations
{
    ...
    [Migration("20230712192111_NullableColorIdInProductEntity")]
    partial class NullableColorIdInProductEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASNClub.Data.Models.Adress.Address", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASNClub.Data.Models.Adress.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ASNClub.Data.Models.Adress.Address", b =>
                {
                    b.HasOne("ASNClub.Data.Models.Adress.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("ASNClub.Data.Models.ApplicationUser", b =>
                {
                    b.HasOne("ASNClub.Data.Models.Adress.Address", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("ASNClub.Data.Models.Orders.Order", b =>
                {
                    ...
                    b.HasOne("ASNClub.Data.Models.Adress.Address", "ShippingAdress")
                        .WithMany()
